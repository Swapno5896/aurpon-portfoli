            ...
            <div className="row">
                ...
                <div className="col-md-6 col-sm-12 d-flex align-items-center  justify-content-center">
                    <div className='contact-detail'>
                        <h2 className='pb-3 text-white'>Content Creation To <br /> Help Others</h2>
                        <p className='pb-2 text-white'>University Admissions, Career guidance and a touch of vlogging- <br /> I love to help my massive following in every way possible.
                        </p>
