                ...
                <div class="container text-white text-center">
                    <div class="row">
                        ...
                        <div className="row video-footer ">
                            <div className="col-md-4 y-video"><iframe width="370" height="250" src="https://www.youtube.com/embed/IkydEhax-A4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
                            <div className="col-md-4 y-video"><iframe width="370" height="250" src="https://www.youtube.com/embed/IkydEhax-A4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
                            <div className="col-md-4 y-video"><iframe width="370" height="250" src="https://www.youtube.com/embed/IkydEhax-A4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
                        </div>
